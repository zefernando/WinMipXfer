 ...
 *      @(#) header inicial
 *      @(#) Modulo mipXfer.h 1.0 10 Oct 2004
...
#define         LOCK                    ".mipXfer.lck"
#define         OPTSTRING               "ahvj:d:t:b:s:AHVJ:D:T:B:S:"
...
#define		stSENDING		(15)
#define		stSENDTRAILER		(16)

#define                 T_GoodReturnRecord                      -900
#define                 T_EndOfDataRecord                       -901
#define                 T_ErrorRecord                           -902
#define                 T_UndefinedData                         -903
